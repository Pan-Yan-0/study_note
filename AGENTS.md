...
- **学习网站**（/mnt/agents/output/app，website_version_manager 发布，type=html）：
  ...
  - kaggle.html 作业指南 / kaggle-code.html 代码精讲（含★全流程地图）/ imdb.html IMDB 教程 / link.html 课程×项目联动表
- **GitHub 仓库**：
...
## 进度快照（更新于用户最新进度 JSON）
- 课程：已看 1–36、42–70（共 65 集）；**缺 37–41（过拟合与正则化）**，计划中。
- Kaggle 作业：Part 1–3 全部完成并提交成功。
- IMDB 脚本包：进入手写 CNN 阶段。
- 待办（用户侧）：Kaggle 手机验证、三遍法第 2 遍盲写、补看 37–41。
